...
-   DML does not discriminate categorical or continuous treatments; what matters is the choice of orthogonal loss. For example, the DR-loss can only be applied to binary treatments, whereas the R-loss can be applied to both categorical and continuous treatments.
