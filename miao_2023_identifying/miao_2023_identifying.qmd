---
title: "Reading Note: Identifying Effects of Multiple Treatments in the Presence of Unmeasured Confounding"
author: "Ming Yuan"
date: "2025-10-04"
format:
  gfm: default
...
- Call $\tilde{f}(y,x,u)$ is admissible if it conforms to the observed data distribution $f(y,x)$, i.e. $f(y,x) = \int_u \tilde{f}(y,x,u) du$. 
...
- Assumptions:
  ...
  - *Completeness*: for any $\alpha$, $f(u|x;\alpha)$ is complete in any $q$-dimensional subvector $x_S$ of the confounded treatment $x_C$. 
