...
$$
where $D_i \in \{0,1\}$ is binary, $Y_i$ is the outcome of interest, 
$e(X_i) = P(D_i = 1|X_i)$ is the probability weighting conditional on the covariates
with $\hat{e}(X_i)$ being its estimate, and $b_n$ is the trimming threshold (the untrimmed IPW estimator is a special case with $b_n = 0$). 
